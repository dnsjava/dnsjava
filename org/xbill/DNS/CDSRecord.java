 ...
 * of the parent zone.
 */
public class CDSRecord extends DSRecordBase {

private static final long serialVersionUID = 1886725731593276503L;
 ...
 */
public CDSRecord(Name name, int dclass, long ttl, int digestid,
				 DNSKEYRecord key)
{
 ...
 */
public CDSRecord(Name name, int dclass, long ttl, int footprint, int alg,
				 int digestid, final byte[] digest)
{
